...
namespace myweb
{
    ...
    {
        private const string TestUrl = "https://3wa.tw/";
...
//            CefExample.Init(new CefSettings(), browserProcessHandler: new BrowserProcessHandler());
        ...
        private async void MainAsync(string cachePath, double zoomLevel)
        {
            ...
            using (var browser = new ChromiumWebBrowser(TestUrl, browserSettings, requestContext))
            {
                ...
                await LoadPageAsync(browser, "http://3wa.tw/test/test_webp.html");
        ...
        private void DisplayBitmap(Task<Bitmap> task)
        {
            // Make a file to save it to (e.g. C:\Users\jan\Desktop\CefSharp screenshot.png)
            string screenshotPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "CefSharp screenshot" + DateTime.Now.Ticks + ".png");
            screenshotPath = @"c:\temp\a.png";
            Console.WriteLine();
